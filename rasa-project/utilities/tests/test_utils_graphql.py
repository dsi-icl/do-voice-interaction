...
class TestRequestsGDO(unittest.TestCase):
    ...
    def test_get_current_project(self):
        ...
        random_name = list(GraphQL.get_projects().values())[0]
        my_graphQL.load_project(random_name)
        self.assertEqual(my_graphQL.get_current_project(),list(GraphQL.get_projects().keys())[0])
